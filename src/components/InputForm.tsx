  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center max-w-2xl mx-auto w-full py-12">
        ...
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl mb-4 leading-tight text-text font-serif font-normal">
            Turn your idea into a<br />
            <span className="text-accent">brand identity</span> — instantly.
          </h1>
        ...
        >
          ...
          <div className="space-y-1.5">
            <label htmlFor="brandName" className="block text-sm font-medium text-text">
              Brand Name
            </label>
            <input
              id="brandName"
              ...
              disabled={isLoading}
              className={`w-full rounded-xl px-4 py-3 text-sm outline-none transition-colors duration-150 disabled:opacity-50 bg-white/6 text-text border ${errors.brandName ? 'border-accent' : 'border-white/10'}`}
            />
            {errors.brandName && (
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              disabled={isLoading}
              className={`w-full rounded-xl px-4 py-3 text-sm outline-none resize-none transition-colors duration-150 disabled:opacity-50 bg-white/6 text-text border ${errors.description ? 'border-accent' : 'border-white/10'}`}
            />
            {errors.description && (
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-4 rounded-xl font-semibold text-sm transition-all duration-150 flex items-center justify-center gap-2 disabled:opacity-60 bg-accent text-white"
          >
            {isLoading ? (
              <>
