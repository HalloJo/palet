  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center max-w-2xl mx-auto w-full py-12">
        ...
        >
          <h1
            className="text-4xl sm:text-5xl md:text-6xl mb-4 leading-16"
            style={{
              color: "#f0f0f0",
          ...
          >
            ...
            <span style={{ color: "#FF6B2B" }}>brand identity</span> —
            instantly.
          </h1>
          <p
            className="text-base"
        ...
        >
          ...
          <div className="space-y-1.5">
            ...
            />
            {errors.brandName && (
              <p className="text-xs mt-1" style={{ color: "#FF6B2B" }}>
                {errors.brandName}
              </p>
            )}
            ...
            <div className="flex flex-wrap gap-2">
              {VIBES.map((v) => (
                <button
                  ...
                  style={{
                    background:
                      vibe === v.value ? "#FF6B2B" : "rgba(255,255,255,0.06)",
